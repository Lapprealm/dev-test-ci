...
XML;
	...
	public function testXMLStructureWrongNumberOfAttributes()
	{
		...
		$actual = new DOMDocument();
		$actual->load(
			$this->filesDirectory . "structureWrongNumberOfAttributes.xml"
		);
	...
	public function testXMLStructureWrongNumberOfNodes()
	{
		...
		$actual = new DOMDocument();
		$actual->load(
			$this->filesDirectory . "structureWrongNumberOfNodes.xml"
		);
	...
	public function testXMLStructureIsSameButDataIsNot()
	{
		...
		$actual = new DOMDocument();
		$actual->load(
			$this->filesDirectory . "structureIsSameButDataIsNot.xml"
		);
	...
	public function testAssertFileExists()
	{
		...
		try {
			$this->assertFileExists(
				__DIR__ . DIRECTORY_SEPARATOR . "NotExisting"
			);
		} catch (PHPUnit_Framework_AssertionFailedError $e) {
			return;
		}
	...
	public function testReadAttribute()
	{
		...
		$this->assertEquals(
			"foo",
			$this->readAttribute($obj, "publicAttribute")
		);
		$this->assertEquals(
			"bar",
	...
	public function testAssertCountThrowsExceptionIfExpectedCountIsNoInteger()
	{
		try {
			...
			$this->assertEquals(
				"Argument #1 (No Value) of PHPUnit_Framework_Assert::assertCount() must be a integer",
				$e->getMessage()
			);
	...
	public function testAssertSameSizeThrowsExceptionIfExpectedIsNotCountable()
	{
		try {
			...
			$this->assertEquals(
				"Argument #1 (No Value) of PHPUnit_Framework_Assert::assertSameSize() must be a countable or traversable",
				$e->getMessage()
			);
	...
	public function testAssertSameSizeThrowsExceptionIfActualIsNotCountable()
	{
		try {
			...
			$this->assertEquals(
				"Argument #2 (No Value) of PHPUnit_Framework_Assert::assertSameSize() must be a countable or traversable",
				$e->getMessage()
			);
	...
	public function testAssertStringMatchesFormatFileThrowsExceptionForInvalidArgument2()
	{
		$this->assertStringMatchesFormatFile(
			$this->filesDirectory . "expectedFileFormat.txt",
			null
		);
	}
