...
class Util_TestDox_NamePrettifierTest extends PHPUnit_Framework_TestCase
{
	...
	public function testTitleHasSensibleDefaults()
	{
		$this->assertEquals(
			"Foo",
			$this->namePrettifier->prettifyTestClass("FooTest")
		);
		$this->assertEquals(
			"Foo",
			$this->namePrettifier->prettifyTestClass("TestFoo")
		);
		$this->assertEquals(
			"Foo",
			$this->namePrettifier->prettifyTestClass("TestFooTest")
		);
		$this->assertEquals(
			"Foo",
			$this->namePrettifier->prettifyTestClass("Test\FooTest")
		);
	}
	...
	public function testCaterForUserDefinedSuffix()
	{
		...
		$this->assertEquals(
			"Foo",
			$this->namePrettifier->prettifyTestClass("FooTestCase")
		);
		$this->assertEquals(
			"TestFoo",
			$this->namePrettifier->prettifyTestClass("TestFoo")
	...
	public function testCaterForUserDefinedPrefix()
	{
		...
		$this->assertEquals(
			"Foo",
			$this->namePrettifier->prettifyTestClass("XXXFoo")
		);
		$this->assertEquals(
			"TestXXX",
			$this->namePrettifier->prettifyTestClass("TestXXX")
		);
		$this->assertEquals(
			"XXX",
			$this->namePrettifier->prettifyTestClass("XXXXXX")
		);
	}
	...
	public function testTestNameIsConvertedToASentence()
	{
		$this->assertEquals(
			"This is a test",
			$this->namePrettifier->prettifyTestMethod("testThisIsATest")
		);
		$this->assertEquals(
			"This is a test",
			$this->namePrettifier->prettifyTestMethod("testThisIsATest2")
		);
		$this->assertEquals(
			"this is a test",
			$this->namePrettifier->prettifyTestMethod("this_is_a_test")
		);
		$this->assertEquals(
			"Foo for bar is 0",
			$this->namePrettifier->prettifyTestMethod("testFooForBarIs0")
		);
		$this->assertEquals(
			"Foo for baz is 1",
			$this->namePrettifier->prettifyTestMethod("testFooForBazIs1")
		);
	}
	...
	public function testTestNameIsNotGroupedWhenNotInSequence()
	{
		$this->assertEquals(
			...
			$this->namePrettifier->prettifyTestMethod(
