...
class PHPUnit_TextUI_TestRunner extends PHPUnit_Runner_BaseTestRunner
{
	...
	private function processSuiteFilters(
	...
	public function doRun(
		...
		if (!$this->printer instanceof PHPUnit_Util_Log_TAP) {
			...
			if (
				isset(
					$arguments[
						"deprecatedCheckForUnintentionallyCoveredCodeSettingUsed"
					]
				)
			) {
		...
		if ($codeCoverageReports > 0) {
			if (!$this->runtime->canCollectCodeCoverage()) {
				...
				!isset($arguments["whitelist"]) &&
				!$this->codeCoverageFilter->hasWhitelist()
			) {
				$this->writeMessage(
					"Error",
		...
		$result->beStrictAboutOutputDuringTests(
			$arguments["disallowTestOutput"]
		);
		$result->beStrictAboutTodoAnnotatedTests(
			...
			if (isset($arguments["coverageText"])) {
				if ($arguments["coverageText"] == "php://stdout") {
					...
					$colors =
						$arguments["colors"] &&
						$arguments["colors"] !=
							PHPUnit_TextUI_ResultPrinter::COLOR_NEVER;
				} else {
					$outputStream = new PHPUnit_Util_Printer(
	...
	protected function handleConfiguration(array &$arguments)
	{
		...
		$arguments["debug"] = isset($arguments["debug"])
			? $arguments["debug"]
			: false;
		$arguments["filter"] = isset($arguments["filter"])
			? $arguments["filter"]
			: false;
		$arguments["listeners"] = isset($arguments["listeners"])
			? $arguments["listeners"]
			: [];
		...
		if (isset($arguments["configuration"])) {
			...
			$phpunitConfiguration = $arguments[
				"configuration"
			...
			if (
				isset($phpunitConfiguration["backupGlobals"]) &&
			...
			if (
				isset($phpunitConfiguration["backupStaticAttributes"]) &&
			...
			if (
				isset(
					$phpunitConfiguration["beStrictAboutChangesToGlobalState"]
				) &&
				!isset($arguments["beStrictAboutChangesToGlobalState"])
			) {
				$arguments["beStrictAboutChangesToGlobalState"] =
					$phpunitConfiguration["beStrictAboutChangesToGlobalState"];
			}

			if (
				isset($phpunitConfiguration["bootstrap"]) &&
			...
			if (
				isset($phpunitConfiguration["cacheTokens"]) &&
			...
			if (
				isset($phpunitConfiguration["colors"]) &&
			...
			if (
				isset($phpunitConfiguration["convertErrorsToExceptions"]) &&
			...
			if (
				isset($phpunitConfiguration["convertNoticesToExceptions"]) &&
			...
			if (
				isset($phpunitConfiguration["processIsolation"]) &&
			...
			if (
				isset($phpunitConfiguration["stopOnError"]) &&
			...
			if (
				isset($phpunitConfiguration["stopOnFailure"]) &&
			...
			if (
				isset($phpunitConfiguration["stopOnWarning"]) &&
				!isset($arguments["stopOnWarning"])
			) {
				$arguments["stopOnWarning"] =
					$phpunitConfiguration["stopOnWarning"];
			}

			if (
				isset($phpunitConfiguration["stopOnIncomplete"]) &&
			...
			if (
				isset($phpunitConfiguration["stopOnRisky"]) &&
			...
			if (
				isset($phpunitConfiguration["stopOnSkipped"]) &&
			...
			if (
				isset($phpunitConfiguration["failOnWarning"]) &&
				!isset($arguments["failOnWarning"])
			) {
				$arguments["failOnWarning"] =
					$phpunitConfiguration["failOnWarning"];
			}

			if (
				isset($phpunitConfiguration["failOnRisky"]) &&
				!isset($arguments["failOnRisky"])
			) {
				$arguments["failOnRisky"] =
					$phpunitConfiguration["failOnRisky"];
			}

			if (
				isset($phpunitConfiguration["timeoutForSmallTests"]) &&
			...
			if (
				isset($phpunitConfiguration["timeoutForMediumTests"]) &&
			...
			if (
				isset($phpunitConfiguration["timeoutForLargeTests"]) &&
			...
			if (
				isset($phpunitConfiguration["reportUselessTests"]) &&
			...
			if (
				isset($phpunitConfiguration["strictCoverage"]) &&
			...
			if (
				isset($phpunitConfiguration["disallowTestOutput"]) &&
			...
			if (
				isset($phpunitConfiguration["enforceTimeLimit"]) &&
			...
			if (
				isset($phpunitConfiguration["disallowTodoAnnotatedTests"]) &&
			...
			if (
				isset($phpunitConfiguration["reverseDefectList"]) &&
				!isset($arguments["reverseList"])
			) {
				$arguments["reverseList"] =
					$phpunitConfiguration["reverseDefectList"];
			}

			if (
				isset($phpunitConfiguration["forceCoversAnnotation"]) &&
			...
			if (
				isset($phpunitConfiguration["disableCodeCoverageIgnore"]) &&
				!isset($arguments["disableCodeCoverageIgnore"])
			) {
				$arguments["disableCodeCoverageIgnore"] =
					$phpunitConfiguration["disableCodeCoverageIgnore"];
			}
			...
			$groupConfiguration = $arguments[
				"configuration"
			]->getGroupConfiguration();

			if (
				!empty($groupConfiguration["include"]) &&
			...
			if (
				!empty($groupConfiguration["exclude"]) &&
				!isset($arguments["excludeGroups"])
			) {
				$arguments["excludeGroups"] = array_diff(
			...
			foreach (
				$arguments["configuration"]->getListenerConfiguration()
				as $listener
			) {
				if (
			...
			$loggingConfiguration = $arguments[
				"configuration"
			]->getLoggingConfiguration();

			if (
				isset($loggingConfiguration["coverage-clover"]) &&
			...
			if (
				isset($loggingConfiguration["coverage-crap4j"]) &&
				...
				if (
					isset($loggingConfiguration["crap4jThreshold"]) &&
			...
			if (
				isset($loggingConfiguration["coverage-html"]) &&
				!isset($arguments["coverageHtml"])
			) {
				if (
					isset($loggingConfiguration["lowUpperBound"]) &&
				...
				if (
					isset($loggingConfiguration["highLowerBound"]) &&
			...
			if (
				isset($loggingConfiguration["coverage-php"]) &&
			...
			if (
				isset($loggingConfiguration["coverage-text"]) &&
				...
				if (
					isset($loggingConfiguration["coverageTextShowOnlySummary"])
				) {
					$arguments["coverageTextShowOnlySummary"] =
			...
			if (
				isset($loggingConfiguration["coverage-xml"]) &&
			...
			if (
				isset($loggingConfiguration["json"]) &&
			...
			if (
				isset($loggingConfiguration["tap"]) &&
			...
			if (
				isset($loggingConfiguration["teamcity"]) &&
				!isset($arguments["teamcityLogfile"])
			) {
				$arguments["teamcityLogfile"] =
					$loggingConfiguration["teamcity"];
			}

			if (
				isset($loggingConfiguration["junit"]) &&
				!isset($arguments["junitLogfile"])
			) {
				$arguments["junitLogfile"] = $loggingConfiguration["junit"];

				if (
					isset($loggingConfiguration["logIncompleteSkipped"]) &&
			...
			if (
				isset($loggingConfiguration["testdox-html"]) &&
			...
			if (
				isset($loggingConfiguration["testdox-text"]) &&
			...
			if (
				...
				foreach (
					$filterConfiguration["whitelist"]["exclude"]["directory"]
					as $dir
				) {
		...
		$arguments["addUncoveredFilesFromWhitelist"] = isset(
			$arguments["addUncoveredFilesFromWhitelist"]
		)
			? $arguments["addUncoveredFilesFromWhitelist"]
			: true;
		$arguments["processUncoveredFilesFromWhitelist"] = isset(
			$arguments["processUncoveredFilesFromWhitelist"]
		)
			? $arguments["processUncoveredFilesFromWhitelist"]
			: false;
		$arguments["backupGlobals"] = isset($arguments["backupGlobals"])
			? $arguments["backupGlobals"]
			: null;
		$arguments["backupStaticAttributes"] = isset(
			$arguments["backupStaticAttributes"]
		)
			? $arguments["backupStaticAttributes"]
			: null;
		$arguments["beStrictAboutChangesToGlobalState"] = isset(
			$arguments["beStrictAboutChangesToGlobalState"]
		)
			? $arguments["beStrictAboutChangesToGlobalState"]
			: null;
		$arguments["cacheTokens"] = isset($arguments["cacheTokens"])
			? $arguments["cacheTokens"]
			: false;
		$arguments["columns"] = isset($arguments["columns"])
			? $arguments["columns"]
			: 80;
		$arguments["colors"] = isset($arguments["colors"])
			? $arguments["colors"]
			: PHPUnit_TextUI_ResultPrinter::COLOR_DEFAULT;
		$arguments["convertErrorsToExceptions"] = isset(
			$arguments["convertErrorsToExceptions"]
		)
			? $arguments["convertErrorsToExceptions"]
			: true;
		$arguments["convertNoticesToExceptions"] = isset(
			$arguments["convertNoticesToExceptions"]
		)
			? $arguments["convertNoticesToExceptions"]
			: true;
		$arguments["convertWarningsToExceptions"] = isset(
			$arguments["convertWarningsToExceptions"]
		)
			? $arguments["convertWarningsToExceptions"]
			: true;
		...
		$arguments["groups"] = isset($arguments["groups"])
			? $arguments["groups"]
			: [];
		$arguments["logIncompleteSkipped"] = isset(
			$arguments["logIncompleteSkipped"]
		)
			? $arguments["logIncompleteSkipped"]
			: false;
		$arguments["processIsolation"] = isset($arguments["processIsolation"])
			? $arguments["processIsolation"]
			: false;
		$arguments["repeat"] = isset($arguments["repeat"])
			? $arguments["repeat"]
			: false;
		$arguments["reportHighLowerBound"] = isset(
			$arguments["reportHighLowerBound"]
		)
			? $arguments["reportHighLowerBound"]
			: 90;
		$arguments["reportLowUpperBound"] = isset(
			$arguments["reportLowUpperBound"]
		)
			? $arguments["reportLowUpperBound"]
			: 50;
		$arguments["crap4jThreshold"] = isset($arguments["crap4jThreshold"])
			? $arguments["crap4jThreshold"]
			: 30;
		...
		$arguments["stopOnFailure"] = isset($arguments["stopOnFailure"])
			? $arguments["stopOnFailure"]
			: false;
		$arguments["stopOnWarning"] = isset($arguments["stopOnWarning"])
			? $arguments["stopOnWarning"]
			: false;
		$arguments["stopOnIncomplete"] = isset($arguments["stopOnIncomplete"])
			? $arguments["stopOnIncomplete"]
			: false;
		$arguments["stopOnRisky"] = isset($arguments["stopOnRisky"])
			? $arguments["stopOnRisky"]
			: false;
		$arguments["stopOnSkipped"] = isset($arguments["stopOnSkipped"])
			? $arguments["stopOnSkipped"]
			: false;
		$arguments["failOnWarning"] = isset($arguments["failOnWarning"])
			? $arguments["failOnWarning"]
			: false;
		$arguments["failOnRisky"] = isset($arguments["failOnRisky"])
			? $arguments["failOnRisky"]
			: false;
		$arguments["timeoutForSmallTests"] = isset(
			$arguments["timeoutForSmallTests"]
		)
			? $arguments["timeoutForSmallTests"]
			: 1;
		$arguments["timeoutForMediumTests"] = isset(
			$arguments["timeoutForMediumTests"]
		)
			? $arguments["timeoutForMediumTests"]
			: 10;
		$arguments["timeoutForLargeTests"] = isset(
			$arguments["timeoutForLargeTests"]
		)
			? $arguments["timeoutForLargeTests"]
			: 60;
		$arguments["reportUselessTests"] = isset(
			$arguments["reportUselessTests"]
		)
			? $arguments["reportUselessTests"]
			: false;
		$arguments["strictCoverage"] = isset($arguments["strictCoverage"])
			? $arguments["strictCoverage"]
			: false;
		$arguments["disallowTestOutput"] = isset(
			$arguments["disallowTestOutput"]
		)
			? $arguments["disallowTestOutput"]
			: false;
		$arguments["enforceTimeLimit"] = isset($arguments["enforceTimeLimit"])
			? $arguments["enforceTimeLimit"]
			: false;
		$arguments["disallowTodoAnnotatedTests"] = isset(
			$arguments["disallowTodoAnnotatedTests"]
		)
			? $arguments["disallowTodoAnnotatedTests"]
			: false;
		$arguments["beStrictAboutResourceUsageDuringSmallTests"] = isset(
			$arguments["beStrictAboutResourceUsageDuringSmallTests"]
		)
			? $arguments["beStrictAboutResourceUsageDuringSmallTests"]
			: false;
		$arguments["reverseList"] = isset($arguments["reverseList"])
			? $arguments["reverseList"]
			: false;
		$arguments["verbose"] = isset($arguments["verbose"])
			? $arguments["verbose"]
			: false;
	}
