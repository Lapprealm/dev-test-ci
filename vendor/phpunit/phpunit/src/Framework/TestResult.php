...
class PHPUnit_Framework_TestResult implements Countable
{
	...
	public function addFailure(
		...
		if (
			$e instanceof PHPUnit_Framework_RiskyTest ||
		...
		if ($collectCodeCoverage) {
			...
			if ($append && $test instanceof PHPUnit_Framework_TestCase) {
				try {
					...
					$this->addWarning(
						$test,
						new PHPUnit_Framework_Warning($cce->getMessage()),
						$time
					);
				}
			}
	 ...
	 * @return bool
	 */
	private function notOnlyBecauseOfComparators(
		PHP_CodeCoverage_UnintentionallyCoveredCodeException $cce
	) {
