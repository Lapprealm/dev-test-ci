 ...
 */
class PHPUnit_Framework_MockObject_Builder_InvocationMocker implements
	PHPUnit_Framework_MockObject_Builder_MethodNameMatch
{
	...
	public function withConsecutive()
	{
		...
		$this->matcher->parametersMatcher = new PHPUnit_Framework_MockObject_Matcher_ConsecutiveParameters(
			$args
		);
	...
	public function method($constraint)
	{
		...
		if (
			...
			!in_array(strtolower($constraint), $this->configurableMethods)
		) {
			throw new PHPUnit_Framework_MockObject_RuntimeException(
				sprintf(
		...
		$this->matcher->methodNameMatcher = new PHPUnit_Framework_MockObject_Matcher_MethodName(
			$constraint
		);
