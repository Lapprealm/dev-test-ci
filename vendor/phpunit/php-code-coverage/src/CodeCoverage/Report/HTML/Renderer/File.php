 ...
 */
class PHP_CodeCoverage_Report_HTML_Renderer_File extends
	PHP_CodeCoverage_Report_HTML_Renderer
{
	...
	public function __construct(
		...
		$this->htmlspecialcharsFlags =
			$this->htmlspecialcharsFlags | ENT_HTML401 | ENT_SUBSTITUTE;
	}
	...
	protected function renderFunctionOrMethodItem(
		...
		$numTestedItems =
			$item["executedLines"] == $item["executableLines"] ? 1 : 0;
