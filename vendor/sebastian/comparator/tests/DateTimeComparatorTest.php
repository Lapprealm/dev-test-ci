...
class DateTimeComparatorTest extends \PHPUnit_Framework_TestCase
{
	...
	public function acceptsFailsProvider()
	{
		...
		return [[$datetime, null], [null, $datetime], [null, null]];
	}
	...
	{
		$this->assertTrue(
			$this->comparator->accepts(new DateTime(), new DateTime())
		);
	}
	...
	{
		$this->assertTrue(
			$this->comparator->accepts(new DateTime(), new DateTimeImmutable())
		);
	}
