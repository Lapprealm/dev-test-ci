...
class SnapshotTest extends PHPUnit_Framework_TestCase
{
	public function testStaticAttributes()
	{
		...
		$blacklist
			->method("isStaticAttributeBlacklisted")
	...
	public function testFunctions()
	{
		...
		$this->assertThat(
			...
			$this->logicalOr(
				// Zend
				$this->contains(
					'sebastianbergmann\globalstate\testfixture\snapshotfunction'
				),
				// HHVM
				$this->contains(
					"SebastianBergmann\GlobalState\TestFixture\snapshotFunction"
				)
			)
		);
