...
class MethodTagTest extends \PHPUnit_Framework_TestCase
{
	...
	public function getTestSignatures()
	{
		return [
			...
			//                false, 'foo', '', false, 0, ''
			//            ),
			["foo()", true, "foo", "void", false, 0, ""],
			["foo() description", true, "foo", "void", false, 0, "description"],
			["int foo()", true, "foo", "int", false, 0, ""],
			[
				"int foo() description",
				true,
				"foo",
			...
			['int foo($a, $b)', true, "foo", "int", false, 2, ""],
			['int foo() foo(int $a, int $b)', true, "foo", "int", false, 2, ""],
			['int foo(int $a, int $b)', true, "foo", "int", false, 2, ""],
			[
			...
			['int foo(null|int $a, int $b)', true, "foo", "int", false, 2, ""],
			[
			...
			["void()", true, "void", "void", false, 0, ""],
			["static foo()", true, "foo", "static", false, 0, ""],
			["static void foo()", true, "foo", "void", true, 0, ""],
			["static static foo()", true, "foo", "static", true, 0, ""],
		];
	}
}
