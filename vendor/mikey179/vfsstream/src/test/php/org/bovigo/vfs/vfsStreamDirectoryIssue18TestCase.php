...
class vfsStreamDirectoryIssue18TestCase extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertTrue(
			$this->rootDirectory->getChild("var/log/app")->hasChild("foo")
		);
	...
	{
		$this->assertTrue(
			$this->rootDirectory->getChild("var/log/app")->hasChild("app1")
		);
		$this->assertInstanceOf(
			'org\\bovigo\\vfs\\vfsStreamDirectory',
	...
	{
		$this->assertTrue(
			$this->rootDirectory->getChild("var/log/app")->hasChild("app2")
		);
		$this->assertInstanceOf(
			'org\\bovigo\\vfs\\vfsStreamDirectory',
