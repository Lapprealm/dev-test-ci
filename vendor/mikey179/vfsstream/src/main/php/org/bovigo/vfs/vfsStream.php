...
class vfsStream
{
	...
	public static function setup(
		...
		return self::create(
			...
			vfsStreamWrapper::setRoot(
				self::newDirectory($rootDirName, $permissions)
			)
		);
	}
	...
	public static function create(
		...
		if (null === $baseDir) {
			throw new \InvalidArgumentException(
				"No baseDir given and no root directory set."
			);
		}
	 ...
	 * @return  vfsStreamDirectory
	 */
	protected static function addStructure(
		array $structure,
		vfsStreamDirectory $baseDir
	) {
		foreach ($structure as $name => $data) {
			...
			if (is_array($data) === true) {
				self::addStructure(
					$data,
					self::newDirectory($name)->at($baseDir)
				);
	...
	public static function inspect(
		vfsStreamVisitor $visitor,
		vfsStreamContent $content = null
	) {
		if (null !== $content) {
		...
		if (null === $root) {
			throw new \InvalidArgumentException(
				"No content given and no root directory set."
			);
		}
