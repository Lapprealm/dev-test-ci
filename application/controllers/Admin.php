...
class Admin extends CI_Controller {
    ...
    public function show_ta($id)
    {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('hmif/admin/ta/show',array('item'=>$item));
        $this->load->view('templates/footer');
    }
    ...
    public function edit_ta($id)
    {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('hmif/admin/ta/edit',array('item'=>$item));
        $this->load->view('templates/footer');
    }
    ...
    public function show_sa($id)
    {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('hmif/admin/sa/show',array('item'=>$item));
        $this->load->view('templates/footer');
    }  
    ...
    public function edit_sa($id)
    {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('hmif/admin/sa/edit',array('item'=>$item));
        $this->load->view('templates/footer');
    }
